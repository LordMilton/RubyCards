    ...
    websocketMtx.synchronize do
      ...
      when 'action'
        ...
        when 'add_card'
          ...
          when 'won_cards'
            gameMaster.addToWonCards(msg['subjectSpecifier'], newCard)
          else
        ...
        when 'remove_card'
          ...
          when 'won_cards'
            gameMaster.removeFromWonCards(msg['subjectSpecifier'], index)
          else
